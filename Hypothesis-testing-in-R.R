...
prop.test(42, 100, p = 0.5, alternative = "two.sided", conf.level = 0.95, correct = TRUE)

## 2.2: What if we ask 1000 people and 420 say yes. 
## Does this still support the 
## null hypothesis that p = 0.5? 

prop.test(420, 1000, p = 0.5, alternative = "two.sided", conf.level = 0.95, correct = TRUE)
...
t.test(withdrug, placebo, alternative = "less", var.equal = T)
